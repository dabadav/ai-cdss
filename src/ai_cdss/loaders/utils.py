...
from ai_cdss.constants import DEFAULT_DATA_DIR, PPF_PARQUET_FILEPATH, DEFAULT_OUTPUT_DIR
...
def _load_protocol_similarity(file_path: str = None) -> pd.DataFrame:
    file_path = Path(file_path) if file_path else DEFAULT_OUTPUT_DIR / "protocol_similarity.csv"
