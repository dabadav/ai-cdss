...
from ai_cdss.models import SessionSchema, TimeseriesSchema, PPFSchema, DataUnit, DataUnitName, Granularity, safe_check_types
from ai_cdss.constants import DEFAULT_DATA_DIR, PPF_PARQUET_FILEPATH, BY_PPS, DM_VALUE
from rgs_interface.data.interface import DatabaseInterface

from .base import DataLoaderBase
from .utils import _load_patient_subscales, _load_protocol_attributes, _load_protocol_similarity, _load_ppf_data
...
class DataLoader(DataLoaderBase):
    ...
    def load_patient_subscales(self, patient_list = List[int]):
    ...
    def _load_data(
        ...
        try:
            ...
            if schema_cls:
                ...
                return DataUnit(name, empty_df, granularity) if wrap_in_dataunit else empty_df
            raise
