...
def generate_synthetic_session_data(shared_ids, columns_with_nulls=None):
    """
...
def generate_synthetic_timeseries_data(shared_ids, num_timepoints=10, columns_with_nulls=None, test_discrepancies=False):
    """
