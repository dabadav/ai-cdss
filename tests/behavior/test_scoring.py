...
# from ai_cdss.constants import RECENT_ADHERENCE, DELTA_DM, PPF, PATIENT_ID, PROTOCOL_ID, SCORE, DAYS, USAGE, USAGE_WEEK
...
#     assert not session.empty, "Expected session DataFrame to contain the prescription"
...
#     processor = DataProcessor()
#     scoring_df = processor.process_data(session, timeseries, ppf, None)
